...
public class VerifyCodeWithdrawl extends JFrame implements ActionListener{
    ...
    public void actionPerformed(ActionEvent ae){
            ...
            try {
                ...
                if (rs.next()) {
                    JOptionPane.showMessageDialog(null, "Rút tiền tiền thành công");
                    setVisible(false);
