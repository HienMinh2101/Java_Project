...
public class VerifyCodeDeposit extends JFrame implements ActionListener{
    ...
    public void actionPerformed(ActionEvent ae){
            ...
            try {
                ...
                if (rs.next()) {
                    JOptionPane.showMessageDialog(null, "Nạp tiền thành công");
                    setVisible(false);
